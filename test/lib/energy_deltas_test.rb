...
class EnergyDeltasTest < ActiveSupport::TestCase
  test "cte sums plausible deltas and zeroes glitches" do
    Plugs::Sample.create!(plug_id: "p1", ts: 1000, apower_w: 100, aenergy_wh: 50)
    Plugs::Sample.create!(plug_id: "p1", ts: 1010, apower_w: 100, aenergy_wh: 51)        # +1 Wh plausible
    Plugs::Sample.create!(plug_id: "p1", ts: 1020, apower_w: 100, aenergy_wh: 1_000_000) # glitch → 0
